...
import com.fleetmanagement.platform.events.PaymentProcessFailedEvent;
...
public class InvoiceAggregate {
    ...
    public InvoiceAggregate(CreateInvoiceCommand createInvoiceCommand){
    	if(createInvoiceCommand.price != null) {
    		BigDecimal priceVal = createInvoiceCommand.price;
    ...
    @EventSourcingHandler
    protected void on(PaymentProcessFailedEvent invoiceCreatedEvent){
    	System.err.println("Invoice Created####"+ invoiceCreatedEvent);
        this.paymentId = invoiceCreatedEvent.paymentId;
        this.orderId = invoiceCreatedEvent.orderId;
        this.invoiceStatus = InvoiceStatus.PAID;
