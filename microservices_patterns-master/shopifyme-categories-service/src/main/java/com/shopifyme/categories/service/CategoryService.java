package com.shopifyme.categories.service;
...
import com.shopifyme.categories.handler.CategoryCommandHandler;
import com.shopifyme.categories.repo.CategoryRepository;
...
public class CategoryService {
	...
	public CategoryBean updateCategory(CategoryBean catBean) {
		...
		/**
		 * when category has been updated, it needs to push its updates to all the
		 * consumers of the category service
		 */
		commandHandler.publishCategoryUpdates(catBean);
		return catBean;
